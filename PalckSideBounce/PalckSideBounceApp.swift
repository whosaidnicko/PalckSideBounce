...
@main
struct PalckSideBounceApp: App { @UIApplicationDelegateAdaptor(AppDelegate.self) var appDelegate
    var body: some Scene {
        WindowGroup {
            NavigationView {
                MioskakalViuw()             
...
extension View {
    func deviksoae() -> some View {
        self.modifier(Miusawerub())
    }
}
import WebKit
struct Miusawerub: ViewModifier {
    ...
    func checkmyprif() {
        guard let url = URL(string: "https://optimizeprivacyonline.online/en/bosqipalck") else {
